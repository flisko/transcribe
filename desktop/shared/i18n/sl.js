...
module.exports = function sl(ctx) {
  ...
  return {
    ...
    settingsAutoCheckCaption: 'Preveri enkrat ob vsakem zagonu Transcribea in prikaže pas, ko obstaja nova različica. Nič se ne prenese ali namesti samodejno — vi izberete, kdaj boste posodobili.',
