...
module.exports = function hr(ctx) {
  ...
  return {
    ...
    updateNow: 'Ažuriraj',
    updateDownloading(pct) { return `Preuzimam ažuriranje — ${pct} %`; },
    updateInstalling: 'Instaliram — Transcribe će se za trenutak ponovno pokrenuti…',
    updateInstallFailed: 'Ažuriranje nije bilo moguće instalirati. Otvaram stranicu za preuzimanje da ažurirate ručno.',
    updateFolderReadOnly: 'Transcribe se ne može ažurirati iz ove mape jer ona ne dopušta promjene. Premjestite mapu Transcribe negdje gdje imate prava (npr. Dokumenti) pa pokušajte ponovno.',
    ...
    settingsAutoCheckCaption: 'Provjerava jednom pri svakom pokretanju Transcribea i prikazuje traku kad postoji nova verzija. Ništa se ne događa dok ne pritisnete „Ažuriraj” — vaši modeli i postavke ostaju netaknuti.',
